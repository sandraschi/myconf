...
4. Start the server:
   ...
   uv run python -m myconf.server

   # HTTP mode (for web dashboard)
   uv run uvicorn myconf.server:app --port 10887
   ```
5. Open `http://localhost:10887` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/myconf/issues) |
